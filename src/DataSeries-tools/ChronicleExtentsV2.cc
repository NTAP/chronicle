...
const char *EXTENT_CHRONICLE_IP = 
    "<ExtentType name=\"trace::net::ip\" namespace=\"atg.netapp.com\" version=\"2.0\" >\n"
...
const char *EXTENT_CHRONICLE_RPCCOMMON =
    "<ExtentType name=\"trace::rpc\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_TIME_N("request_at", "rpc request time in ")
    FIELD_TIME_N("reply_at", "rpc reply time in ")
    "  <field name=\"client\" type=\"int32\" comment=\"32-bit packed IPv4 address\" print_format=\"%08x\" />\n"
    "  <field name=\"client_port\" type=\"int32\" />\n"
    "  <field name=\"server\" type=\"int32\" comment=\"32-bit packed IPv4 address\" print_format=\"%08x\" />\n"
    "  <field name=\"server_port\" type=\"int32\" />\n"
...
//    "  <field name=\"is_request\" type=\"bool\" print_true=\"request\" print_false=\"response\" />\n"
    ...
    "  <field name=\"call_header_offset\" type=\"int32\" opt_nullable=\"yes\" comment=\"offset in bytes of the rpc header in the 1st IP packet\" />\n"
    "  <field name=\"call_payload_length\" type=\"int32\" opt_nullable=\"yes\" comment=\"length in bytes of the rpc call/reply\"/>\n"
    "  <field name=\"reply_header_offset\" type=\"int32\" opt_nullable=\"yes\" comment=\"offset in bytes of the rpc header in the 1st IP packet\" />\n"
    "  <field name=\"reply_payload_length\" type=\"int32\" opt_nullable=\"yes\" comment=\"length in bytes of the rpc call/reply\"/>\n"
   FIELD_RECORD_ID
    "</ExtentType>\n";

const char *EXTENT_CHRONICLE_NFS3_GETATTR =
    "<ExtentType name=\"trace::rpc::nfs3::getattr\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_SETATTR =
    "<ExtentType name=\"trace::rpc::nfs3::setattr\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_LOOKUP =
    "<ExtentType name=\"trace::rpc::nfs3::lookup\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    GROUP_DIROPARGS("")
    FIELD_NFSSTAT
...
const char *EXTENT_CHRONICLE_NFS3_ACCESS =
    "<ExtentType name=\"trace::rpc::nfs3::access\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_READLINK =
    "<ExtentType name=\"trace::rpc::nfs3::readlink\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_READWRITE =
    "<ExtentType name=\"trace::rpc::nfs3::readwrite\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_RWCHECKSUM =
    "<ExtentType name=\"trace::rpc::nfs3::rwchecksum\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    "  <field name=\"offset\" type=\"int64\" comment=\"file offset in bytes\" />\n"
...
const char *EXTENT_CHRONICLE_NFS3_CREATE =
    "<ExtentType name=\"trace::rpc::nfs3::create\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    GROUP_DIROPARGS("")
...
const char *EXTENT_CHRONICLE_NFS3_REMOVE =
    "<ExtentType name=\"trace::rpc::nfs3::remove\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    GROUP_DIROPARGS("")
    FIELD_NFSSTAT
    GROUP_WCC_DATA("parent_")
...
const char *EXTENT_CHRONICLE_NFS3_RENAME =
    "<ExtentType name=\"trace::rpc::nfs3::rename\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_LINK =
    "<ExtentType name=\"trace::rpc::nfs3::link\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_READDIR =
    "<ExtentType name=\"trace::rpc::nfs3::readdir\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_READDIR_ENTRIES =
    "<ExtentType name=\"trace::rpc::nfs3::readdir::entries\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_FSSTAT =
    "<ExtentType name=\"trace::rpc::nfs3::fsstat\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_NFS3_FSINFO =
    "<ExtentType name=\"trace::rpc::nfs3::fsinfo\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    FIELD_NFSFH("filehandle", "handle within file system to query")
    FIELD_NFSSTAT
    GROUP_FATTR("")
...
const char *EXTENT_CHRONICLE_NFS3_PATHCONF =
    "<ExtentType name=\"trace::rpc::nfs3::pathconf\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
    FIELD_NFSFH("filehandle", "handle within file system to query")
    FIELD_NFSSTAT
    GROUP_FATTR("")
...
const char *EXTENT_CHRONICLE_NFS3_COMMIT =
    "<ExtentType name=\"trace::rpc::nfs3::commit\" namespace=\"atg.netapp.com\" version=\"2.0\">\n"
    FIELD_RECORD_ID
...
const char *EXTENT_CHRONICLE_STATS = 
    "<ExtentType name=\"chronicle::stats\" namespace=\"atg.netapp.com\" version=\"2.0\" >\n"
